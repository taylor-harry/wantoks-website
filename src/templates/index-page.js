              ...
              <div className="content">
                <div className="columns">
                  <div className="column is-12">
                    ...
                    <br />
                    <br />
                    <p style={{ fontSize: `18px` }}>A group of volunteers make up the Executive Team to help run the association. Executive meetings are held at the end of each month except during the festive season (i.e. December – January).</p>
                    <br />
